              ...
              <ImageBackground 
               ...
               style={{ width: '100%', height: '100%' , borderRadius:15}}>
                      ...
                      <View style={styles.thumb} >
                          ...
                          <View style={styles.circleShape}>
                                <Text style={{
                                  ...
                                  textAlign:'center',
                                  fontSize: isAndroid() ? 8:15,color: 'white'}}>OK</Text>
                      ...
                      <View  style={[{flexDirection:'row', flex:0.2, justifyContent:'flex-end',marginTop:-5,marginEnd:20}]} >
                            <Icon name={"bookmark"} size={isAndroid() ? 25 : 50 } color={'green'} />
                      </View>
                        }
                ...
                <Text style={[{
                 ...
                 marginVertical:5,
                  fontSize: isAndroid() ? StyleConfig.resHeight(26)  : StyleConfig.resHeight(26),
                   fontWeight:'700',  color:  'black' }]} >{item.title}</Text>
                <Text style={[{fontFamily:primary_regular_font.primary_regular_font,
                  fontSize: isAndroid() ? StyleConfig.resHeight(20) :StyleConfig.resHeight(24), 
                  color:'black', fontWeight:'400'}]}>{DATA.type}</Text>
                        ...
                        width: isAndroid() ? 150: 333}}>
                            <Text style={[{
                              ...
                              fontSize:StyleConfig.resHeight(26),
                               color: 'black', 
                               fontWeight:'400'}]}>{`${DATA.match} match`}</Text>
                               <View 
...
const styles = StyleSheet.create({
  ...
  circleShape: {
    ...
    highlightFocused:{
      ...
      height: isAndroid() ?  StyleConfig.width*0.28 : StyleConfig.width*0.30,
