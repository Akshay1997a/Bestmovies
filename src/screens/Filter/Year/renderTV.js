    ...
    return (
      <View style={{margin: 5}}>
        <View style={{margin: 10, padding: 10}}>
          ...
          <TouchableOpacity>
            <Text style={styles.fontText}> {strings.last_5_year}</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{borderRadius: 25}}>
            <Text style={styles.fontText}> {strings.last_10_year}</Text>
          </TouchableOpacity>
          <TouchableOpacity>
            <Text style={styles.fontText}> Last 20 Year</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.touchabletext}
            onPress={() => this.setState({isSelected: styles.touchabletext})}>
            <Text
              style={{
                fontWeight: '700',
                padding: 10,
        ...
        <Text style={{fontSize: 15, marginLeft: 10, fontWeight: '700'}}>
          {strings.customized_text}
        </Text>
