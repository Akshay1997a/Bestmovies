...
import { Text, View,Dimensions,SafeAreaView,FlatList,TouchableOpacity,StyleSheet,Image, ScrollView} from 'react-native'
      ...
      return (
            <SafeAreaView>
                        ...
                        <ScrollView nestedScrollEnabled ={true} marginBottom={window/3} showsVerticalScrollIndicator={false}>
                                <View style={{flexDirection:'row'}}>
                                    <View style={{flex:5}}>
                                    <Text style={{fontSize:15,fontWeight:'700',margin:10}}>{strings.subscription}</Text>
                                    </View>
                                    <View style={{flex:1}}>
                                    ...
                                    <SafeAreaView style={{backgroundColor:'#d1d0cd',margin:10,borderRadius:10,height:screen/2}}>
                                        ...
                                        <View style={{flexDirection:'row'}}>
                                                <View style={{flex:5}}>
                                                <Text style={{fontSize:15,fontWeight:'700',margin:10}}>{strings.rent_n_buy}</Text>
                                                </View>
                                                <View style={{flex:1}}>
                                                <Text style={{fontSize:15,fontWeight:'700',margin:10,justifyContent:'flex-end'}}>0</Text>
                                                </View>
